...
## Project Structure
    ...
    ├── testapiautostorybo_125986  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_125986`
...
2. Clone this repo and `cd testapiautostorybo_125986`
